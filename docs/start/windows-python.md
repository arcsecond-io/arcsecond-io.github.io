...
If you are on macOS or Linux, see [Install & Login](/reference/cli-login) instead.
...
[Install & Login](/reference/cli-login#authentication) for the login step.
...
Continue with [Authentication](/reference/cli-login#authentication) to log in with
