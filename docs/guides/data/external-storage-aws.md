---
title: "Creating a read-only IAM user for an S3 bucket"
visibility: public
audience: astronomer
tier: guide
source: handwritten
...
# Creating a read-only IAM user for an S3 bucket

*The Amazon S3 entry of [External Storages](./external-storages).*
