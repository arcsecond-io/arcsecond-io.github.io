...
- the hourly database backups (see [Backups](/guides/operating/backups)).

Because it is a plain directory on your machine, you back it up, snapshot it and
size it with your own operational practice. The [Backups](/guides/operating/backups) and
[disaster-recovery](/guides/operating/backups#what-else-to-back-up-off-host) guides cover
