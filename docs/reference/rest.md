...
[Arcsecond.local](/concepts/arcsecond-local) install — exposes the same **RESTful** API. The
easiest way to talk to it is the [CLI / Python module](/reference/python-basics), but the
...
The [CLI](/reference/python-basics) handles all of this for you once you have logged in.

## How data is organised

Data files live inside **[Datasets](/guides/data/datasets)**, which are simply
containers of files. When you [upload from the CLI](/reference/upload), the files you
